...
## Setup 
* Ensure you have dockernet setup properly including all submodules up to date and the `TESSOR_ADMIN_MNEMONIC` enviornment variable set 
...
## Start Tessor Local
* Build tessor and the relayers
```
make build-docker build=srh
```
* Start a local tessor and setup all the commands needed to test the flow
```

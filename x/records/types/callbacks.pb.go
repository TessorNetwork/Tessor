...
// source: tessor/records/callbacks.proto
...
func init() {
	proto.RegisterType((*TransferCallback)(nil), "tessor.records.TransferCallback")
}

func init() { proto.RegisterFile("tessor/records/callbacks.proto", fileDescriptor_6f7cdd5c1d8b3a46) }

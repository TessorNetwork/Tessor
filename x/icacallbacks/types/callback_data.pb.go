...
// source: tessor/icacallbacks/callback_data.proto
...
func init() {
	proto.RegisterType((*CallbackData)(nil), "tessor.icacallbacks.CallbackData")
}

func init() {
	proto.RegisterFile("tessor/icacallbacks/callback_data.proto", fileDescriptor_19b6f19ce856679b)
}

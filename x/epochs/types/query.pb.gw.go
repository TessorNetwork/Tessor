...
var (
	pattern_Query_EpochInfos_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"Tessornetwork", "tessor", "epochs"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_CurrentEpoch_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"Tessornetwork", "tessor", "epochs", "current_epoch"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_EpochInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"Tessornetwork", "tessor", "epochs", "epoch_info"}, "", runtime.AssumeColonVerbOpt(false)))
)

...
// source: tessor/claim/params.proto
...
type Airdrop struct {
	...
	// utess tokens claimed so far in the current period
...
func init() {
	proto.RegisterType((*Params)(nil), "tessor.claim.Params")
	proto.RegisterType((*Airdrop)(nil), "tessor.claim.Airdrop")
}

func init() { proto.RegisterFile("tessor/claim/params.proto", fileDescriptor_dd7ac871d3875dc3) }

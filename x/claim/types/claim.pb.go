...
// source: tessor/claim/claim.proto
...
func init() {
	proto.RegisterEnum("tessor.claim.Action", Action_name, Action_value)
	proto.RegisterType((*ClaimRecord)(nil), "tessor.claim.ClaimRecord")
}

func init() { proto.RegisterFile("tessor/claim/claim.proto", fileDescriptor_b4747d999b9dc0da) }

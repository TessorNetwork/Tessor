...
func init() {
	proto.RegisterType((*MsgSetAirdropAllocations)(nil), "tessor.claim.MsgSetAirdropAllocations")
	proto.RegisterType((*MsgSetAirdropAllocationsResponse)(nil), "tessor.claim.MsgSetAirdropAllocationsResponse")
	proto.RegisterType((*MsgClaimFreeAmount)(nil), "tessor.claim.MsgClaimFreeAmount")
	proto.RegisterType((*MsgClaimFreeAmountResponse)(nil), "tessor.claim.MsgClaimFreeAmountResponse")
	proto.RegisterType((*MsgCreateAirdrop)(nil), "tessor.claim.MsgCreateAirdrop")
	proto.RegisterType((*MsgCreateAirdropResponse)(nil), "tessor.claim.MsgCreateAirdropResponse")
	proto.RegisterType((*MsgDeleteAirdrop)(nil), "tessor.claim.MsgDeleteAirdrop")
	proto.RegisterType((*MsgDeleteAirdropResponse)(nil), "tessor.claim.MsgDeleteAirdropResponse")
}

func init() { proto.RegisterFile("tessor/claim/tx.proto", fileDescriptor_9d435242bf328977) }
...
func (c *msgClient) SetAirdropAllocations(ctx context.Context, in *MsgSetAirdropAllocations, opts ...grpc.CallOption) (*MsgSetAirdropAllocationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tessor.claim.Msg/SetAirdropAllocations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ClaimFreeAmount(ctx context.Context, in *MsgClaimFreeAmount, opts ...grpc.CallOption) (*MsgClaimFreeAmountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tessor.claim.Msg/ClaimFreeAmount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CreateAirdrop(ctx context.Context, in *MsgCreateAirdrop, opts ...grpc.CallOption) (*MsgCreateAirdropResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tessor.claim.Msg/CreateAirdrop", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeleteAirdrop(ctx context.Context, in *MsgDeleteAirdrop, opts ...grpc.CallOption) (*MsgDeleteAirdropResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tessor.claim.Msg/DeleteAirdrop", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SetAirdropAllocations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tessor.claim.Msg/SetAirdropAllocations",
	}
...
func _Msg_ClaimFreeAmount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tessor.claim.Msg/ClaimFreeAmount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_CreateAirdrop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tessor.claim.Msg/CreateAirdrop",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DeleteAirdrop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tessor.claim.Msg/DeleteAirdrop",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "tessor/claim/tx.proto",
}

...
Example:
$ %s query claim claimable-for-action tessor1h4astdfzjhcwahtfrh24qtvndzzh49xvqtfftk ActionLiquidStake
`,
				version.AppName,
			),
		),
...
Example:
$ %s query claim total-claimable tessor tessor1h4astdfzjhcwahtfrh24qtvndzzh49xvqtfftk true
`,
				version.AppName,
			),
		),
...
Example:
$ %s query claim user-vestings tessor1h4astdfzjhcwahtfrh24qtvndzzh49xvqtfftk
`,
				version.AppName,
			),
		),

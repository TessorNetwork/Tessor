...
func init() {
	...
	distributorAddrs = []string{
		"tessor1ajerf2nmxsg0u728ga7665fmlfguqxcd8e36vf",
		"tessor1zkfk3q70ranm3han4lvutvcvetncxg829j972a",
	}
}
...
func (s *IntegrationTestSuite) SetupSuite() {
	...
	for idx := range distributorMnemonics {
		...
		_, err = banktestutil.MsgSendExec(
			...
			tessorclitestutil.DefaultFeeString(s.cfg),
		)
		s.Require().NoError(err)
	}
...
func (s *IntegrationTestSuite) TestCmdTxSetAirdropAllocations() {
	...
	claimRecords := []claimtypes.ClaimRecord{
		{
			Address:           "tessor1k8g9sagjpdwreqqf0qgqmd46l37595ea5ft9x6",
			Weight:            sdk.NewDecWithPrec(50, 2), // 50%
			ActionCompleted:   []bool{false, false, false},
			AirdropIdentifier: claimtypes.DefaultAirdropIdentifier,
		},
		{
			Address:           "tessor1av5lwh0msnafn04xkhdyk6mrykxthrawy7uf3d",

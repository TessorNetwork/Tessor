...
import (
	...
	vestexported "github.com/TessorNetwork/tessor/v4/x/claim/vesting/exported"
)

// Compile-time type assertions
var (
	_ authtypes.AccountI          = (*BaseVestingAccount)(nil)
	_ vestexported.VestingAccount = (*TessorPeriodicVestingAccount)(nil)
)
...
// Periodic Vesting Account (only for tessor)
// This vesting account works differently from the core periodic vesting account.
var _ vestexported.VestingAccount = (*TessorPeriodicVestingAccount)(nil)
var _ authtypes.GenesisAccount = (*TessorPeriodicVestingAccount)(nil)

// NewTessorPeriodicVestingAccountRaw creates a new TessorPeriodicVestingAccount object from BaseVestingAccount
func NewTessorPeriodicVestingAccountRaw(bva *BaseVestingAccount, startTime int64, periods Periods) *TessorPeriodicVestingAccount {
	return &TessorPeriodicVestingAccount{
		BaseVestingAccount: bva,
		VestingPeriods:     periods,
	}
}

// NewTessorPeriodicVestingAccount returns a new TessorPeriodicVestingAccount
func NewTessorPeriodicVestingAccount(baseAcc *authtypes.BaseAccount, originalVesting sdk.Coins, periods Periods) *TessorPeriodicVestingAccount {
	if len(periods) == 0 {
		return &TessorPeriodicVestingAccount{}
	}
...
func (pva *TessorPeriodicVestingAccount) AddNewGrant(grantedPeriod Period) {
...
// nil is returned.
func (pva TessorPeriodicVestingAccount) GetVestedCoins(blockTime time.Time) sdk.Coins {
...
func (pva TessorPeriodicVestingAccount) GetVestingCoins(blockTime time.Time) sdk.Coins {
	return pva.OriginalVesting.Sub(pva.GetVestedCoins(blockTime)...)
}

// LockedCoins returns the set of coins that are not spendable (i.e. locked),
// defined as the vesting coins that are not delegated.
func (pva TessorPeriodicVestingAccount) LockedCoins(blockTime time.Time) sdk.Coins {
...
func (pva *TessorPeriodicVestingAccount) TrackDelegation(blockTime time.Time, balance, amount sdk.Coins) {
...
// account.
func (pva TessorPeriodicVestingAccount) GetStartTime() int64 {
	return pva.VestingPeriods[0].StartTime
}

// GetVestingPeriods returns vesting periods associated with periodic vesting account.
func (pva TessorPeriodicVestingAccount) GetVestingPeriods() Periods {
	return pva.VestingPeriods
}

// Validate checks for errors on the account fields
func (pva TessorPeriodicVestingAccount) Validate() error {
...
func (pva TessorPeriodicVestingAccount) String() string {
	out, _ := pva.MarshalYAML()
	return out.(string)
}

// MarshalYAML returns the YAML representation of a TessorPeriodicVestingAccount.
func (pva TessorPeriodicVestingAccount) MarshalYAML() (interface{}, error) {

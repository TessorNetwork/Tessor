...
// source: tessor/vesting/vesting.proto
...
// TessorPeriodicVestingAccount implements the VestingAccount interface. It
// periodically vests by unlocking coins during each specified period.
type TessorPeriodicVestingAccount struct {
...
func (m *TessorPeriodicVestingAccount) Reset()      { *m = TessorPeriodicVestingAccount{} }
func (*TessorPeriodicVestingAccount) ProtoMessage() {}
func (*TessorPeriodicVestingAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_41f0278a453c26b3, []int{2}
}
func (m *TessorPeriodicVestingAccount) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TessorPeriodicVestingAccount) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TessorPeriodicVestingAccount.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TessorPeriodicVestingAccount) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TessorPeriodicVestingAccount.Merge(m, src)
}
func (m *TessorPeriodicVestingAccount) XXX_Size() int {
	return m.Size()
}
func (m *TessorPeriodicVestingAccount) XXX_DiscardUnknown() {
	xxx_messageInfo_TessorPeriodicVestingAccount.DiscardUnknown(m)
}

var xxx_messageInfo_TessorPeriodicVestingAccount proto.InternalMessageInfo

func init() {
	proto.RegisterType((*BaseVestingAccount)(nil), "tessor.vesting.BaseVestingAccount")
	proto.RegisterType((*Period)(nil), "tessor.vesting.Period")
	proto.RegisterType((*TessorPeriodicVestingAccount)(nil), "tessor.vesting.TessorPeriodicVestingAccount")
}

func init() { proto.RegisterFile("tessor/vesting/vesting.proto", fileDescriptor_41f0278a453c26b3) }
...
func (m *TessorPeriodicVestingAccount) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TessorPeriodicVestingAccount) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TessorPeriodicVestingAccount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TessorPeriodicVestingAccount) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TessorPeriodicVestingAccount) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TessorPeriodicVestingAccount: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TessorPeriodicVestingAccount: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {

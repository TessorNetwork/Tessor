...
func (s *KeeperTestSuite) SetupMsgSubmitQueryResponse() MsgSubmitQueryResponseTestCase {
	...
	// save the query to Tessor state, so it can be retrieved in the response
	query := types.Query{
		Id:           expectedId,
...
// As a first pass, to verify proof checking, we will use an example from Tessor integration testing

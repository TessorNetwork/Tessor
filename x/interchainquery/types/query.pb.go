...
// source: tessor/interchainquery/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryPendingQueriesRequest)(nil), "tessor.interchainquery.v1.QueryPendingQueriesRequest")
	proto.RegisterType((*QueryPendingQueriesResponse)(nil), "tessor.interchainquery.v1.QueryPendingQueriesResponse")
}

func init() {
	proto.RegisterFile("tessor/interchainquery/v1/query.proto", fileDescriptor_b720c147b9144d5b)
}
...
func (c *queryServiceClient) PendingQueries(ctx context.Context, in *QueryPendingQueriesRequest, opts ...grpc.CallOption) (*QueryPendingQueriesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tessor.interchainquery.v1.QueryService/PendingQueries", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _QueryService_PendingQueries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tessor.interchainquery.v1.QueryService/PendingQueries",
	}
...
var _QueryService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tessor.interchainquery.v1.QueryService",
	...
	Metadata: "tessor/interchainquery/v1/query.proto",
}

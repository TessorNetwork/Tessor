...
func (s *KeeperTestSuite) SetupRebalanceCallback() RebalanceCallbackTestCase {
	...
	callbackArgs := types.RebalanceCallback{
		...
		Rebalancings: []*types.Rebalancing{
			{
				SrcValidator: "tessor_VAL3",
				DstValidator: "tessor_VAL1",
				Amt:          sdkmath.NewInt(104),
			},
			{
				SrcValidator: "tessor_VAL4",
				DstValidator: "tessor_VAL1",
...
func (s *KeeperTestSuite) TestRebalanceCallback_WrongValidator() {
	...
	callbackArgs := types.RebalanceCallback{
		...
		Rebalancings: []*types.Rebalancing{
			...
			{
				SrcValidator: "tessor_VAL4_WRONG",
				DstValidator: "tessor_VAL1",
				Amt:          sdkmath.NewInt(13),
			},
		},
	...
	callbackArgs = types.RebalanceCallback{
		...
		Rebalancings: []*types.Rebalancing{
			{
				SrcValidator: "tessor_VAL3",
				DstValidator: "tessor_VAL1_WRONG",
				Amt:          sdkmath.NewInt(104),
			},
			{
				SrcValidator: "tessor_VAL4",
	...
	s.Require().EqualError(err, "validator not found tessor_VAL4_WRONG: invalid request")
	s.checkDelegationStateIfCallbackFailed()
	...
	s.Require().EqualError(err, "validator not found tessor_VAL1_WRONG: invalid request")
	s.checkDelegationStateIfCallbackFailed()
}

...
// source: tessor/stakeibc/ica_account.proto
...
type ICAAccount struct {
	...
	Target  ICAAccountType `protobuf:"varint,3,opt,name=target,proto3,enum=tessor.stakeibc.ICAAccountType" json:"target,omitempty"`
}
...
func init() {
	proto.RegisterEnum("tessor.stakeibc.ICAAccountType", ICAAccountType_name, ICAAccountType_value)
	proto.RegisterType((*ICAAccount)(nil), "tessor.stakeibc.ICAAccount")
}

func init() { proto.RegisterFile("tessor/stakeibc/ica_account.proto", fileDescriptor_2976ae6e7f6ce824) }

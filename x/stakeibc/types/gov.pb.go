...
// source: tessor/stakeibc/gov.proto
...
func init() {
	proto.RegisterType((*AddValidatorProposal)(nil), "tessor.stakeibc.AddValidatorProposal")
}

func init() { proto.RegisterFile("tessor/stakeibc/gov.proto", fileDescriptor_8204317b384c5680) }

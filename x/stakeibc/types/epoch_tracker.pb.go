...
// source: tessor/stakeibc/epoch_tracker.proto
...
func init() {
	proto.RegisterType((*EpochTracker)(nil), "tessor.stakeibc.EpochTracker")
}

func init() {
	proto.RegisterFile("tessor/stakeibc/epoch_tracker.proto", fileDescriptor_e7c48143f24adf66)
}

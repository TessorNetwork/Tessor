...
// source: tessor/stakeibc/validator.proto
...
type Validator struct {
	...
	Status               Validator_ValidatorStatus              `protobuf:"varint,3,opt,name=status,proto3,enum=tessor.stakeibc.Validator_ValidatorStatus" json:"status,omitempty"`
...
func init() {
	proto.RegisterEnum("tessor.stakeibc.Validator_ValidatorStatus", Validator_ValidatorStatus_name, Validator_ValidatorStatus_value)
	proto.RegisterType((*ValidatorExchangeRate)(nil), "tessor.stakeibc.ValidatorExchangeRate")
	proto.RegisterType((*Validator)(nil), "tessor.stakeibc.Validator")
}

func init() { proto.RegisterFile("tessor/stakeibc/validator.proto", fileDescriptor_5d2f32e16bd6ab8f) }

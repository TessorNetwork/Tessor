...
// source: tessor/stakeibc/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "tessor.stakeibc.GenesisState")
	proto.RegisterMapType((map[string]string)(nil), "tessor.stakeibc.GenesisState.DenomToHostZoneEntry")
}

func init() { proto.RegisterFile("tessor/stakeibc/genesis.proto", fileDescriptor_dea81129ed6fb77a) }

...
// source: tessor/stakeibc/min_validator_requirements.proto
...
func init() {
	proto.RegisterType((*MinValidatorRequirements)(nil), "tessor.stakeibc.MinValidatorRequirements")
}

func init() {
	proto.RegisterFile("tessor/stakeibc/min_validator_requirements.proto", fileDescriptor_c53a743ee7ad112e)
}

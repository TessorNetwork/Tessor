...
// source: tessor/stakeibc/host_zone.proto
...
func init() {
	proto.RegisterType((*HostZone)(nil), "tessor.stakeibc.HostZone")
}

func init() { proto.RegisterFile("tessor/stakeibc/host_zone.proto", fileDescriptor_f81bf5b42c61245a) }

...
// source: tessor/stakeibc/params.proto
...
// next id: 18
type Params struct {
	// define epoch lengths, in tessor_epochs
	...
	TessorCommission       uint64 `protobuf:"varint,4,opt,name=tessor_commission,json=tessorCommission,proto3" json:"tessor_commission,omitempty"`
	// zone_com_address stores which addresses to
	// send the Tessor commission too, as well as what portion
...
func (m *Params) GetTessorCommission() uint64 {
	if m != nil {
		return m.TessorCommission
	}
	return 0
}
...
func init() {
	proto.RegisterType((*Params)(nil), "tessor.stakeibc.Params")
	proto.RegisterMapType((map[string]string)(nil), "tessor.stakeibc.Params.ZoneComAddressEntry")
}

func init() { proto.RegisterFile("tessor/stakeibc/params.proto", fileDescriptor_5aeaab6a38c2b438) }
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TessorCommission != 0 {
		i = encodeVarintParams(dAtA, i, uint64(m.TessorCommission))
		i--
		dAtA[i] = 0x20
	}
...
func (m *Params) Size() (n int) {
	...
	if m.TessorCommission != 0 {
		n += 1 + sovParams(uint64(m.TessorCommission))
	}
	if len(m.ZoneComAddress) > 0 {
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TessorCommission", wireType)
			}
			m.TessorCommission = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowParams
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TessorCommission |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}

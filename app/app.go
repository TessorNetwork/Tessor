...
import (
	...
	claimvesting "github.com/TessorNetwork/tessor/v4/x/claim/vesting"
	claimvestingtypes "github.com/TessorNetwork/tessor/v4/x/claim/vesting/types"

	"github.com/TessorNetwork/tessor/v4/x/mint"
	mintkeeper "github.com/TessorNetwork/tessor/v4/x/mint/keeper"
	minttypes "github.com/TessorNetwork/tessor/v4/x/mint/types"
	...
	epochsmodule "github.com/TessorNetwork/tessor/v4/x/epochs"
	epochsmodulekeeper "github.com/TessorNetwork/tessor/v4/x/epochs/keeper"
	epochsmoduletypes "github.com/TessorNetwork/tessor/v4/x/epochs/types"

	"github.com/TessorNetwork/tessor/v4/x/interchainquery"
	interchainquerykeeper "github.com/TessorNetwork/tessor/v4/x/interchainquery/keeper"
	interchainquerytypes "github.com/TessorNetwork/tessor/v4/x/interchainquery/types"

	"github.com/TessorNetwork/tessor/v4/x/claim"
	claimkeeper "github.com/TessorNetwork/tessor/v4/x/claim/keeper"
	claimtypes "github.com/TessorNetwork/tessor/v4/x/claim/types"
	icacallbacksmodule "github.com/TessorNetwork/tessor/v4/x/icacallbacks"
	icacallbacksmodulekeeper "github.com/TessorNetwork/tessor/v4/x/icacallbacks/keeper"
	icacallbacksmoduletypes "github.com/TessorNetwork/tessor/v4/x/icacallbacks/types"
	recordsmodule "github.com/TessorNetwork/tessor/v4/x/records"
	recordsmodulekeeper "github.com/TessorNetwork/tessor/v4/x/records/keeper"
	recordsmoduletypes "github.com/TessorNetwork/tessor/v4/x/records/types"
	stakeibcmodule "github.com/TessorNetwork/tessor/v4/x/stakeibc"
	stakeibcclient "github.com/TessorNetwork/tessor/v4/x/stakeibc/client"
	stakeibcmodulekeeper "github.com/TessorNetwork/tessor/v4/x/stakeibc/keeper"
	stakeibcmoduletypes "github.com/TessorNetwork/tessor/v4/x/stakeibc/types"
...
var (
	_ servertypes.Application = (*TessorApp)(nil)
	_ ibctesting.TestingApp   = (*TessorApp)(nil)
)
...
// TessorApp extends an ABCI application, but with most of its parameters exported.
// They are exported for convenience in creating helper functions, as object
// capabilities aren't needed for testing.
type TessorApp struct {
	*baseapp.BaseApp
...
func (app *TessorApp) Name() string { return app.BaseApp.Name() }

// GetBaseApp returns the base app of the application
func (app *TessorApp) GetBaseApp() *baseapp.BaseApp { return app.BaseApp }

// GetStakingKeeper implements the TestingApp interface.
func (app *TessorApp) GetStakingKeeper() ibctestingtypes.StakingKeeper {
	return app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *TessorApp) GetTransferKeeper() *ibctransferkeeper.Keeper {
	return &app.TransferKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *TessorApp) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

// GetScopedIBCKeeper implements the TestingApp interface.
func (app *TessorApp) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.ScopedIBCKeeper
}

// GetTxConfig implements the TestingApp interface.
func (app *TessorApp) GetTxConfig() client.TxConfig {
	cfg := MakeEncodingConfig()
	return cfg.TxConfig
}

// BeginBlocker application updates every begin block
func (app *TessorApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

// EndBlocker application updates every end block
func (app *TessorApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// InitChainer application update at chain initialization
func (app *TessorApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *TessorApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *TessorApp) ModuleAccountAddrs() map[string]bool {
...
// ModuleAccountAddrs returns all the app's module account addresses.
func (app *TessorApp) BlacklistedModuleAccountAddrs() map[string]bool {
	modAccAddrs := make(map[string]bool)
	// DO NOT REMOVE: StringMapKeys fixes non-deterministic map iteration
	for _, acc := range utils.StringMapKeys(maccPerms) {
...
func (app *TessorApp) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}
...
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *TessorApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns an InterfaceRegistry
func (app *TessorApp) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *TessorApp) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *TessorApp) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *TessorApp) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *TessorApp) GetSubspace(moduleName string) paramstypes.Subspace {
...
// API server.
func (app *TessorApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *TessorApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *TessorApp) RegisterTendermintService(clientCtx client.Context) {
...
func (app *TessorApp) SimulationManager() *module.SimulationManager {
	return app.sm
}
